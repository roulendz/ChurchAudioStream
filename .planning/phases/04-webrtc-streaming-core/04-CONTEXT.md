...
- Graceful shutdown: notify listeners -> drain 5-10s -> close mediasoup workers -> close GStreamer pipelines (matches specifics section shutdown order)
...
<audit-findings>
## Pre-Phase 04 Audit Findings

See [04-AUDIT.md](./04-AUDIT.md) for full audit findings, including blockers fixed, DRY/SRP violations, architecture improvements, and best practices.
