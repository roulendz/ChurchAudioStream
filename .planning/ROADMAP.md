...
Plans:
- [ ] 01-01: Tauri 2.x project scaffolding with Node.js sidecar bootstrap
- [ ] 01-02: Express web server and WebSocket signaling in sidecar
- [ ] 01-03: JSON configuration store with persistence and validation
...
|-------|----------------|--------|-----------|
| 1. Project Foundation & Configuration | 0/3 | Not started | - |
